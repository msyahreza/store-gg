...
export default function EditProfile() {
	return (
		<>
			<section className="overflow-auto edit-profile">
							...
							<form action="">
								<div className="photo d-flex">
									<div className="position-relative me-20">
										...
										/>
										<div className="top-0 avatar-overlay position-absolute d-flex justify-content-center align-items-center">
											<svg
												width="24"
												height="24"
												viewBox="0 0 24 24"
								...
								<div className="button-group d-flex flex-column pt-50">
									<button
										type="submit"
										className="text-lg text-white btn btn-save fw-medium rounded-pill"
										role="button"
									>
										Save My Profile
									</button>
