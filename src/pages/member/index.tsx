      ...
      <>
        ...
        <section className="sidebar">
            <div className="content pt-50 pb-30 ps-30">
                <div className="text-center user pb-50 pe-30">
                    <img src="/img/avatar-1.png" width="90" height="90" className="mb-20 img-fluid" />
                    <h2 className="m-0 text-xl fw-bold color-palette-1">Shayna Anne</h2>
                    <p className="m-0 color-palette-2">shayna@anne.com</p>
                </div>
                <div className="menus">
                ...
                <div className="sidebar-footer pt-73 pe-30">
                    <div className="footer-card">
                        ...
                        <a className="text-xs text-center text-white btn btn-get-started w-100 fw-medium rounded-pill"
                            ...
                            <div className="pb-4 col-lg-4 ps-15 pe-15 pb-lg-0">
                                <div className="categories-card">
                                    <div className="mb-24 d-flex align-items-center">
                                        ...
                                        <p className="mb-0 color-palette-1 ms-12">Game<br /> Desktop</p>
                                    </div>
                                    <div>
                                        <p className="mb-1 text-sm color-palette-2">Total Spent</p>
                                        <p className="m-0 text-2xl color-palette-1 fw-medium">Rp 18.000.500</p>
                                    </div>
                                </div>
                            </div>
                            <div className="pb-4 col-lg-4 ps-15 pe-15 pb-lg-0">
                                <div className="categories-card">
                                    <div className="mb-24 d-flex align-items-center">
                                        ...
                                        <p className="mb-0 color-palette-1 ms-12">Game<br /> Mobile</p>
                                    </div>
                                    <div>
                                        <p className="mb-1 text-sm color-palette-2">Total Spent</p>
                                        <p className="m-0 text-2xl color-palette-1 fw-medium">Rp 8.455.000</p>
                                    </div>
                                </div>
                            </div>
                            <div className="pb-4 col-lg-4 ps-15 pe-15 pb-lg-0">
                                <div className="categories-card">
                                    <div className="mb-24 d-flex align-items-center">
                                        ...
                                        <p className="mb-0 color-palette-1 ms-12">Other<br/> Categories</p>
                                    </div>
                                    <div>
                                        <p className="mb-1 text-sm color-palette-2">Total Spent</p>
                                        <p className="m-0 text-2xl color-palette-1 fw-medium">Rp 5.000.000</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table className="table table-borderless">
                            ...
                            <tbody>
                                <tr className="align-middle">
                                    ...
                                    <td>
                                        <p className="m-0 fw-medium text-start color-palette-1">Rp 290.000</p>
                                    </td>
                                    <td>
                                        <div>
                                ...
                                <tr className="text-center align-middle">
                                    ...
                                    <td>
                                        <p className="m-0 fw-medium text-start color-palette-1">550 Gold</p>
                                    </td>
                                    <td>
                                        <p className="m-0 fw-medium text-start color-palette-1">Rp 740.000</p>
                                    </td>
                                    <td>
                                        <div>
                                ...
                                <tr className="text-center align-middle">
                                    ...
                                    <td>
                                        <p className="m-0 fw-medium text-start color-palette-1">100 Gold</p>
                                    </td>
                                    <td>
                                        <p className="m-0 fw-medium text-start color-palette-1">Rp 120.000</p>
                                    </td>
                                    <td>
                                        <div>
                                ...
                                <tr className="text-center align-middle">
                                    ...
                                    <td>
                                        <p className="m-0 fw-medium text-start color-palette-1">225 Gold</p>
                                    </td>
                                    <td>
                                        <p className="m-0 fw-medium text-start color-palette-1">Rp 200.000</p>
                                    </td>
                                    <td>
                                        <div>
                                            <span className="float-start icon-status pending"></span>
