	...
	return (
		<>
					...
					<div className="container-fluid">
						...
						<div className="collapse navbar-collapse" id="navbarNav">
							<ul className="gap-2 text-lg navbar-nav ms-auto gap-lg-0">
								...
								<li className="my-auto nav-item me-lg-20">
									<a className="nav-link" href="#">
										Global Rank
									</a>
								</li>
					...
					<div className="gap-4 row gap-lg-0" data-aos="fade-up">
						<div className="col-lg-4">
							<div className="border-0 card feature-card">
								...
								<p className="mb-2 text-2xl fw-semibold color-palette-1">
									1. Start
								</p>
							...
							<a href="/detail">
								...
								<div className="bottom-0 m-32 cover position-absolute">
									<div className="d-flex flex-column h-100 justify-content-between text-decoration-none">
										...
										<div>
											<p className="m-0 text-xl text-white fw-semibold">
												Super Mechs
											</p>
											<p className="m-0 text-white fw-light">Mobile</p>
										</div>
									</div>
								</div>
							</a>
								...
								<div className="bottom-0 m-32 cover position-absolute">
									<div className="d-flex flex-column h-100 justify-content-between text-decoration-none">
										...
										<div>
											...
											<p className="m-0 text-white fw-light">Desktop</p>
										</div>
									</div>
								</div>
							</a>
			...
			<section className="reached pt-50 pb-50">
				<div className="container-fluid">
					<div className="gap-4 d-flex flex-lg-row flex-column align-items-center justify-content-center gap-lg-0">
						<div className="me-lg-35">
							<p className="m-0 text-4xl text-center text-lg-start color-palette-1 fw-bold">
								290M+
							</p>
							<p className="m-0 text-lg text-center text-lg-start color-palette-2">
								Players Top Up
							</p>
						</div>
						<div className="vertical-line me-lg-35 ms-lg-35 d-lg-block d-none"></div>
						<div className="mt-6 mb-6 horizontal-line me-lg-35 ms-lg-35 d-lg-none d-block"></div>
			...
			<section className="story pt-50 pb-50">
				<div className="container-xxl container-fluid">
					<div className="gap-4 mx-auto row align-items-center px-lg-5 gap-lg-0">
						<div
						...
						<div className="col-lg-5 col-12 ps-lg-60">
							<div className="">
								...
								<div className="d-md-block d-flex flex-column w-100">
									<a
										className="text-lg btn btn-read rounded-pill"
										href="#"
										role="button"
									>
										Read Story
